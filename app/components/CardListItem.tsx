...
export interface CardListItemProps extends TouchableOpacityProps {
  /**
 ...
 * @param {CardListItemProps} props - The props for the `ListItem` component.
...
export function CardListItem(props: CardListItemProps) {
  ...
  const $textStyles = [
    ...
    $textStyleOverride,
    TextProps?.style,
    { overflow: "hidden", paddingVertical: spacing.xxxs },
  ]
  ...
  const $touchableStyles = [
    $touchableStyle,
    { minHeight: height, paddingVertical: spacing.md },
    style,
  ]
